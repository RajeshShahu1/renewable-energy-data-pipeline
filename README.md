...
* **DynamoDB Table** (`energy_data`)
  ...
  * energy_generated_kwh (float) – Energy generated by the site in kilowatt-hours
  * energy_consumed_kwh (float) – Energy consumed by the site in kilowatt-hours
  * net_energy_kwh (float) – Calculated as generated - consumed
